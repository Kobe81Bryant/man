package com.quartz.man;

import com.quartz.man.quartz.QuartzManager;
import com.quartz.man.quartz.TestTask;
...
public class ManApplicationTests {
	...
	private Logger logger = LoggerFactory.getLogger(ManApplicationTests.class);
